// =============================================================
//  Conteúdo do portfólio — edite aqui para atualizar o site.
// =============================================================

export const profile = {
  name: "Alexandre Pastore",
  role: "Acadêmico de T.I. & Instrutor FitDance",
  location: "Rio de Janeiro, RJ",
  tagline: "Onde a precisão técnica encontra o olhar criativo.",
...
export const skills = {
  ...
  soft: ["Organização", "Comunicação", "Extroversão", "Lecionar"],
};
...
export const projects = [
  {
    name: "EstudaJá",
    description:
      "Guia de estudos para organizar a rotina de aprendizado, acompanhar conteúdos e estudar de forma mais inteligente.",
    tech: ["Next.js", "Vercel"],
    url: "https://estudaja-ten.vercel.app",
  },
  {
    name: "Rotina da Bela",
    description:
      "App de hábitos diários para acompanhar tarefas e construir consistência no dia a dia.",
    tech: ["Next.js", "Vercel"],
    url: "https://rotina-bela.vercel.app",
  },
];
